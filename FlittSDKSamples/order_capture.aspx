<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="order_capture.aspx.cs" Inherits="FlittSDKSamples.OrderCapture" %>
...
<div class="container">
    <% if (ResponeData != null)
       { %>
        ...
        <% }
           ...
           { %>
            <h2>Order Capture Response data</h2>
            <table class="table table-sm">
                <tr>
                    <td>Capture status</td>
                    <td><% Response.Write(CaptureResp.capture_status); %></td>
                </tr>
                <tr>
                    <td>Response Description</td>
                    <td><% Response.Write(CaptureResp.response_description); %></td>
                </tr>
            </table>
    ...
    <% }
       ...
       { %>
        <form runat="server">
            <fieldset>
                <legend>Generate Order to Capture</legend>
