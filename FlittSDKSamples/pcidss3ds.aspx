<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="pcidss3ds.aspx.cs" Inherits="FlittSDKSamples.Pcidss3dsSample" %>
    ...
    <% }
       ...
       { %>
        <form runat="server">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input id="card_number" class="form-control" type="text" autocomplete="off" name="card_number" value="<%
                                                                                                                              ...
                                                                                                                              {
                                                                                                                                  Response.Write("4444555566661111");
                                                                                                                              }
                                                                                                                              else
                                                                                                                              {
            ...
            <asp:Button ID="btnSubmitNon3ds" CssClass="btn btn-primary" Text="Submit 3ds" runat="server"/>
        </form>
    <% } %>
</div>
</body>
